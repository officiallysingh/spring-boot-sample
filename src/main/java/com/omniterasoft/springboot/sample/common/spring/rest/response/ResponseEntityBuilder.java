package com.omniterasoft.springboot.sample.common.spring.rest.response;

import com.omniterasoft.springboot.sample.common.spring.rest.response.builder.AbstractResponseBuilder;
import com.omniterasoft.springboot.sample.common.spring.rest.response.builder.BodyBuilder;
import com.omniterasoft.springboot.sample.common.spring.rest.response.builder.HeaderBuilder;
import com.omniterasoft.springboot.sample.common.spring.rest.response.builder.StatusBuilder;
import java.net.URI;
