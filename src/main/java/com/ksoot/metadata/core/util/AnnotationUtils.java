...
public final class AnnotationUtils implements Serializable {
   ...
   * @return String value, or <code>defaultValue</code> if <code>annotationValue</code> is an empty
   *     string
   */
  public static String getStringValue(String annotationValue, String defaultValue) {
    return (annotationValue != null && !annotationValue.equals(EMPTY_STRING_ANNOTATION_VALUE))
        ? annotationValue
        : defaultValue;
  }

  /**
   * Get the first {@link Annotation} of given <code>annotationClass</code> from given <code>
   * annotations</code> set, if available.
   *
  ...
  public static <A extends Annotation> Optional<A> getAnnotation(
      Annotation[] annotations, Class<A> annotationClass) {
    Assert.notNull(annotationClass, "Annotation class must be not null");
    if (annotations != null) {
  ...
  /**
   * Get the class which is annotated with given <code>annotation</code>, checking any superclass
   * and implemented interface.
   *
   * @param cls Class to inspect (not null)
   * @param annotation Annotation to look for (not null)
   * @return The class (or implemented interface) on which the annotation is present, <code>null
   *     </code> if not found
   */
  public static Class<?> getClassWithAnnotation(
  ...
  /**
   * Get whether the class is annotated with given <code>annotation</code>, checking any superclass
   * and implemented interface.
   *
   * @param cls Class to inspect (not null)
   * @param annotation Annotation to look for (not null)
  ...
  /**
   * Get a single annotation of given <code>annotationType</code> present in given <code>element
   * </code>, including any meta-annotation and supporting repeatable annotations.
   *
   * @param <A> Annotation type
   * @param element Annotated element to inspect (not null)
   * @param annotationType Annotation type to lookup (not null)
   * @return Optional annotation value, if found. If more than one annotation is found, the first
   *     one is returned
   */
  public static <A extends Annotation> Optional<A> getAnnotation(
  ...
  /**
   * Get all the annotations of given <code>annotationType</code> present in given <code>element
   * </code>, including any meta-annotation and supporting repeatable annotations.
   *
   * @param <A> Annotation type
   * @param element Annotated element to inspect (not null)
   * @param annotationType Annotation type to lookup (not null)
   * @return List of detected annotation of given <code>annotationType</code>, an empty List if none
   *     found
   */
  public static <A extends Annotation> List<A> getAnnotations(
      AnnotatedElement element, Class<A> annotationType) {
    Assert.notNull(element, "AnnotatedElement must be not null");
    Assert.notNull(annotationType, "Annotation type must be not null");
  ...
  /**
   * Get all the annotations of given <code>annotationType</code> present in given annotations list,
   * including any meta-annotation and supporting repeatable annotations.
   *
   * @param <A> Annotation type
  ...
  @SuppressWarnings("unchecked")
  public static <A extends Annotation> List<A> getAnnotations(
      List<Annotation> annotations, Class<A> annotationType) {
    Assert.notNull(annotationType, "Annotation type must be not null");
  ...
  /**
   * Find the annotations of given <code>annotationType</code> on given element and stores them in
   * given <code>accumulator</code>.
   *
   ...
   */
  private static <A extends Annotation> void findAnnotations(
      List<A> accumulator,
      AnnotatedElement element,
      Class<A> annotationType,
      Class<? extends Annotation> repeatableContainerType) {
      ...
      for (Annotation annotation : all) {
        if (!isInJavaLangAnnotationPackage(annotation)
            ...
            && (repeatableContainerType == null
                || !annotation.annotationType().equals(repeatableContainerType))) {
          findAnnotations(
              accumulator, annotation.annotationType(), annotationType, repeatableContainerType);
        }
      }
    }
  }
  ...
  /**
   * Check if the specified {@link Annotation} is defined in the core JDK <code>java.lang.annotation
   * </code> package.
   *
