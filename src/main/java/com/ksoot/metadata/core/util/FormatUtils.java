...
public final class FormatUtils implements Serializable {
  ...
  /**
   * Returns the given object String representation using {@link Object#toString()} if not <code>
   * null</code>.
   *
   * @param obj Object for which to obtain the String representation
   * @return The {@link Object#toString()} representation or <code>null</code> of given object is
   *     <code>null</code>
   */
   ...
   * @param addDots <code>true</code> to add three dots (<code>...</code>) at the end of the
   *     truncated String when String is longer than given <code>maxLength</code>
   * @return The String, truncated at <code>maxLength</code> size if it was longer than given <code>
   *     maxLength</code>
   */
  ...
  /**
   * Replace any message argument identified by given <code>placeholder</code> with given argument
   * values.
   *
   * @param placeholder Argument placeholder (not null)
   * @param message Message to process
   * @param arguments Message arguments
   * @return Message with resolved arguments, or <code>null</code> if the message was <code>null
   *     </code>
   */
  public static String resolveMessageArguments(
      String placeholder, String message, Object[] arguments) {
    Assert.hasText(placeholder, "Argument placeholder must be not null");
    if (message != null && arguments != null && arguments.length > 0) {
      ...
      for (Object argument : arguments) {
        resolved =
            pattern.matcher(resolved).replaceFirst((argument != null) ? argument.toString() : "");
      }
      return resolved;
    }
    return message;
